...
export function Settings({ show, players, setPlayers, setShow, minWordLength, setMinWordLength }) {
  if (!show) { return null; }
  return (
    <>
              ...
              <div key={i} className="player-row">
                ...
                <div class={`remove-player-button ${players.length === 1 ? 'disabled' : ''}`} onClick={() => {
                  ...
                  <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path id="Vector" d="M9 9L11.9999 11.9999M11.9999 11.9999L14.9999 14.9999M11.9999 11.9999L9 14.9999M11.9999 11.9999L14.9999 9M12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21Z" stroke="#000000" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </div>
              </div>
            ))}
  ...
  return (
    <>
      ...
      <div class="container">
        ...
        <div>
          <Settings show={editPlayers} players={players} setPlayers={setPlayers} setShow={setEditPlayers} minWordLength={minWordLength} setMinWordLength={setMinWordLength} />
        </div>
      </div>
    </>
  )
